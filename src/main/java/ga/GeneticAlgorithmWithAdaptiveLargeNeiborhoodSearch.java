...
// 2302.0245910988792
public class GeneticAlgorithmWithAdaptiveLargeNeiborhoodSearch {
    // параметры ГА
...
//                }
                ...
                if (childs != null) {
                    ...
                    var genotype2 = childs.getValue();
                    genotype2.fitness = calculateFitness(genotype2.permutation, problemInstance.jobs, problemInstance.alpha, problemInstance.energy);
...
//                    w = 13;
                    } else if (genotype1.fitness <= parent1.fitness || genotype2.fitness <= parent1.fitness
                            || genotype1.fitness <= parent2.fitness || genotype2.fitness <= parent2.fitness) {
                        w = 0.3;
                    }
                    if (INCLUDE_ZERO) {
                    ...
                    childs = new Pair<>(parent1, parent2);
                }
